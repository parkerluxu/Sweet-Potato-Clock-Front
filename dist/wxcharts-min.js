...
function calLegendData(t, e, i) {
  ...
  var a = 5,
    ...
    l = [];
  return t.forEach(function(t) {
    var i = 3 * a + o + mesureText(t.name || "undefinded");
    s + i > e.width ? (r.push(l), s = i, l = [t]) : (s += i, l.push(t))
  }), l.length && r.push(l), {
    legendList: r,
    legendHeight: r.length * (i.fontSize + n) + a
  }
}
...
function drawRingTitle(t, e, i) {
  var a = t.title.fontSize || e.titleFontSize,
    ...
    c = 5;
  if (r) {
    var x = mesureText(r, n),
      g = (t.width - x) / 2,
      f = (t.height - e.legendHeight + n) / 2;
    o && (f -= (h + c) / 2), i.beginPath(), i.setFontSize(n), i.setFillStyle(l), i.fillText(r, g, f), i.stroke(), i.closePath()
  }
  if (o) {
    var u = mesureText(o, a),
      P = (t.width - u) / 2,
      y = (t.height - e.legendHeight + a) / 2;
    r && (y += (d + c) / 2), i.beginPath(), i.setFontSize(a), i.setFillStyle(s), i.fillText(o, P, y), i.stroke(), i.closePath()
  }
}
...
function drawYAxisTitle(t, e, i, a) {
  ...
  a.save(), a.beginPath(), a.setFontSize(i.fontSize), a.setFillStyle("#333333"), a.translate(0, e.height), a.rotate(-90 * Math.PI / 180), a.fillText(t, n, i.padding + .5 * i.fontSize), a.stroke(), a.closePath(), a.restore()
}
...
function drawXAxis(t, e, i, a) {
  ...
  var c = e.width - 2 * i.padding - i.yAxisWidth - i.yAxisTitleWidth,
    x = Math.min(t.length, Math.ceil(c / i.fontSize / 1.5)),
    g = Math.ceil(t.length / x);
  t = t.map(function(t, e) {
    return e % g !== 0 ? "" : t
  }), 0 === i._xAxisTextAngle_ ? (a.beginPath(), a.setFontSize(i.fontSize), a.setFillStyle("#666666"), t.forEach(function(t, e) {
    var n = l / 2 - mesureText(t) / 2;
    a.fillText(t, o[e] + n, h + i.fontSize + 5)
  }), a.closePath(), a.stroke()) : t.forEach(function(t, n) {
    a.save(), a.beginPath(), a.setFontSize(i.fontSize), a.setFillStyle("#666666");
    var r = mesureText(t),
      s = l / 2 - r,
...
function drawYAxis(t, e, i, a) {
  if (e.yAxis.disabled !== !0) {
    ...
    a.beginPath(), a.setStrokeStyle("#cccccc"), a.setLineWidth(1), x.forEach(function(t, e) {
      a.moveTo(h, t), a.lineTo(d, t)
    }), a.closePath(), a.stroke(), a.beginPath(), a.setFontSize(i.fontSize), a.setFillStyle("#666666"), o.forEach(function(t, e) {
      var n = x[e] ? x[e] : c;
...
function drawLegend(t, e, i, a) {
  if (e.legend) {
    ...
    o.forEach(function(t, n) {
      var o = 0;
      t.forEach(function(t) {
        t.name = t.name || "undefined", o += 3 * r + mesureText(t.name) + l
      });
      var h = (e.width - o) / 2 + r,
        d = e.height - i.padding - i.legendHeight + n * (i.fontSize + s) + r + s;
      a.setFontSize(i.fontSize), t.forEach(function(t) {
        switch (e.type) {
          case "line":
            a.beginPath(), a.setLineWidth(1), a.setStrokeStyle(t.color), a.moveTo(h - 2, d + 5), a.lineTo(h + 17, d + 5), a.stroke(), a.closePath(), a.beginPath(), a.setLineWidth(1), a.setStrokeStyle("#ffffff"), a.setFillStyle(t.color), a.moveTo(h + 7.5, d + 5), a.arc(h + 7.5, d + 5, 4, 0, 2 * Math.PI), a.fill(), a.stroke(), a.closePath();
            break;
          case "pie":
          case "ring":
            a.beginPath(), a.setFillStyle(t.color), a.moveTo(h + 7.5, d + 5), a.arc(h + 7.5, d + 5, 7, 0, 2 * Math.PI), a.closePath(), a.fill();
            break;
          default:
            a.beginPath(), a.setFillStyle(t.color), a.moveTo(h, d), a.rect(h, d, 15, 10), a.closePath(), a.fill()
        }
        h += r + l, a.beginPath(), a.setFillStyle("#333333"), a.fillText(t.name, h, d + 9), a.closePath(), a.stroke(), h += mesureText(t.name) + 2 * r
      })
    })
  }
}
...
function drawPieDataPoints(t, e, i, a) {
  ...
  }), "ring" === e.type && (a.beginPath(), a.setFillStyle("#ffffff"), a.moveTo(o.x, o.y), a.arc(o.x, o.y, .6 * r, 0, 2 * Math.PI), a.closePath(), a.fill()), e.dataLabel !== !1 && 1 === n && drawPieText(t, e, i, a, r, o), 1 === n && "ring" === e.type && drawRingTitle(e, i, a)
}
...
function drawCharts(t, e, i, a) {
  ...
  var r = calLegendData(n, e, i),
    s = r.legendHeight;
  i.legendHeight = s;
  var l = calYAxisData(n, e, i),
    h = l.yAxisWidth;
  if (i.yAxisWidth = h, o && o.length) {
    var d = calCategoriesData(o, e, i),
      c = d.xAxisHeight,
      x = d.angle;
    i.xAxisHeight = c, i._xAxisTextAngle_ = x
  }
  "pie" !== t && "ring" !== t || (i._pieTextMaxLength_ = e.dataLabel === !1 ? 0 : getPieTextMaxLength(n));
  var g = e.animation ? 1e3 : 0;
  switch (t) {
    case "line":
      Animation({
        timing: "easeIn",
...
var config = {
  ...
  Charts = function(t) {
    t.title = t.title || {}, t.subtitle = t.subtitle || {}, t.yAxis = t.yAxis || {}, t.xAxis = t.xAxis || {}, t.legend = t.legend !== !1, t.animation = t.animation !== !1;
    var e = assign({}, config);
    e.yAxisTitleWidth = t.yAxis.disabled !== !0 && t.yAxis.title ? e.yAxisTitleWidth : 0, e.pieChartLinePadding = t.dataLabel === !1 ? 0 : e.pieChartLinePadding, e.pieChartTextPadding = t.dataLabel === !1 ? 0 : e.pieChartTextPadding;
