...
Page({
  ...
  getDayStatic: function(dateStr) {
    ...
    wx.request({
      url: 'http://127.0.0.1:8080/displayuserstastic/displayuserstasticday',
      method: 'GET',
      data: {
        userId: wx.getStorageSync('openid'),
        date: dateStr,
  ...
  getWeekStatic: function(dateStr) {
    var that = this
    wx.request({
      url: 'http://127.0.0.1:8080/displayuserstastic/displayuserstasticweek',
      method: 'GET',
      data: {
        userId: wx.getStorageSync('openid'),
        date: dateStr,
  ...
  getMonthStatic: function (dateStr) {
    ...
    wx.request({
      url: 'http://127.0.0.1:8080/displayuserstastic/displayuserstasticmonth',
      method: 'GET',
      data: {
        userId: wx.getStorageSync('openid'),
        date: dateStr,
